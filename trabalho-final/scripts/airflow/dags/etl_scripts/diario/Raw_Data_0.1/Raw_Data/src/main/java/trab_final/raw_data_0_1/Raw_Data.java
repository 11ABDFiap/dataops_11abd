...
package trab_final.raw_data_0_1;
...
/**
 * Job: Raw_Data Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Raw_Data implements TalendJob {
...
public String getSalesOrderHeader_Raw(){
	...
	private final String jobName = "Raw_Data";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Raw_Data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:pkLf9JtMLZa7kIbJHNBJpxf/LMP27M4Usq61jEca8+vDaML9yA==");
...
class DeleteFoldertFileDelete_1{
	...
	java.io.File path_tFileDelete_1=new java.io.File(context.LocalPath+context.SalesOrderHeader_Raw);
    ...
    globalMap.put("tFileDelete_1_DELETE_PATH",context.LocalPath+context.SalesOrderHeader_Raw);
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TRAB_FINAL_Raw_Data = new byte[0];
    static byte[] commonByteArray_TRAB_FINAL_Raw_Data = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TRAB_FINAL_Raw_Data.length) {
				if(length < 1024 && commonByteArray_TRAB_FINAL_Raw_Data.length == 0) {
   					commonByteArray_TRAB_FINAL_Raw_Data = new byte[1024];
				} else {
   					commonByteArray_TRAB_FINAL_Raw_Data = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TRAB_FINAL_Raw_Data, 0, length);
			strReturn = new String(commonByteArray_TRAB_FINAL_Raw_Data, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TRAB_FINAL_Raw_Data) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.LocalPath+context.SalesOrderHeader_Raw)).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("SalesOrderNumber");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("PurchaseOrderNumber");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("AccountNumber");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
...
+"rowguid,\n		SalesLT.SalesOrderHeader.ModifiedDate\nFROM	SalesLT.SalesOrderHeader";
            ...
            row1.SubTotal = rs_tDBInput_1.getDouble(16);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.TaxAmt = rs_tDBInput_1.getDouble(17);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.Freight = rs_tDBInput_1.getDouble(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.TotalDue = rs_tDBInput_1.getDouble(19);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.OrderDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.DueDate != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.DueDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.ShipDate != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.ShipDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        sb_tFileOutputDelimited_1.append(
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_2{
	...
	java.io.File path_tFileDelete_2=new java.io.File(context.LocalPath+context.Product_Raw);
    ...
    globalMap.put("tFileDelete_2_DELETE_PATH",context.LocalPath+context.Product_Raw);
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File(context.LocalPath+context.Product_Raw)).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_3, false),"UTF-8"));
                                    if(filetFileOutputDelimited_3.length()==0){
                                        ...
                                        outtFileOutputDelimited_3.write("DiscontinuedDate");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
                                        outtFileOutputDelimited_3.write("ThumbNailPhoto");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
                                        outtFileOutputDelimited_3.write("ThumbnailPhotoFileName");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
...
+"\n		SalesLT.Product.rowguid,\n		SalesLT.Product.ModifiedDate\nFROM	SalesLT.Product";
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.ProductNumber = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.ProductNumber = tmpContent_tDBInput_3;
                }
            } else {
                row3.ProductNumber = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.Color = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.Color = tmpContent_tDBInput_3;
                }
            } else {
                row3.Color = null;
            }
            ...
            row3.StandardCost = rs_tDBInput_3.getDouble(5);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.ListPrice = rs_tDBInput_3.getDouble(6);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.Size = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.Size = tmpContent_tDBInput_3;
                }
            } else {
                row3.Size = null;
            }
            ...
            row3.Weight = rs_tDBInput_3.getBigDecimal(8);
            if(rs_tDBInput_3.wasNull()){
                    row3.Weight = null;
            }
		                    }
            ...
            row3.ProductCategoryID = rs_tDBInput_3.getInt(9);
            if(rs_tDBInput_3.wasNull()){
                    row3.ProductCategoryID = null;
            }
		                    }
            ...
            row3.ProductModelID = rs_tDBInput_3.getInt(10);
            if(rs_tDBInput_3.wasNull()){
                    row3.ProductModelID = null;
            }
		                    }
			...
			row3.SellStartDate = mssqlGTU_tDBInput_3.getDate(rsmd_tDBInput_3, rs_tDBInput_3, 11);
			...
			row3.SellEndDate = mssqlGTU_tDBInput_3.getDate(rsmd_tDBInput_3, rs_tDBInput_3, 12);
			...
			row3.DiscontinuedDate = mssqlGTU_tDBInput_3.getDate(rsmd_tDBInput_3, rs_tDBInput_3, 13);
            ...
            row3.ThumbNailPhoto = rs_tDBInput_3.getObject(14);
            if(rs_tDBInput_3.wasNull()){
                    row3.ThumbNailPhoto = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(15).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.ThumbnailPhotoFileName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.ThumbnailPhotoFileName = tmpContent_tDBInput_3;
                }
            } else {
                row3.ThumbnailPhotoFileName = null;
            }
            ...
            row3.rowguid = rs_tDBInput_3.getObject(16);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row3.ModifiedDate = mssqlGTU_tDBInput_3.getDate(rsmd_tDBInput_3, rs_tDBInput_3, 17);
 ...
 */
	...
	currentComponent="tFileOutputDelimited_3";
                    ...
                    StringBuilder sb_tFileOutputDelimited_3 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_3.append(
                            FormatterUtils.format_Date(row3.SellStartDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                            if(row3.SellEndDate != null) {
                        sb_tFileOutputDelimited_3.append(
                            FormatterUtils.format_Date(row3.SellEndDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                            if(row3.DiscontinuedDate != null) {
                        sb_tFileOutputDelimited_3.append(
                            FormatterUtils.format_Date(row3.DiscontinuedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                            if(row3.ThumbNailPhoto != null) {
                        sb_tFileOutputDelimited_3.append(
                            row3.ThumbNailPhoto
                        );
                            }
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                            if(row3.ThumbnailPhotoFileName != null) {
                        sb_tFileOutputDelimited_3.append(
                            row3.ThumbnailPhotoFileName
                        );
                            }
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                        ...
                        sb_tFileOutputDelimited_3.append(
                            FormatterUtils.format_Date(row3.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_3{
	...
	java.io.File path_tFileDelete_3=new java.io.File(context.LocalPath+context.SalesOrderDetail_Raw);
    ...
    globalMap.put("tFileDelete_3_DELETE_PATH",context.LocalPath+context.SalesOrderDetail_Raw);
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.LocalPath+context.SalesOrderDetail_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_2 != null && directory_tFileOutputDelimited_2.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"UTF-8"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("SalesOrderDetailID");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
...
+"edDate\nFROM	SalesLT.SalesOrderDetail";
            ...
            row2.UnitPrice = rs_tDBInput_2.getDouble(5);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row2.UnitPriceDiscount = 0;
							} else {
	                         		
            row2.UnitPriceDiscount = rs_tDBInput_2.getDouble(6);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row2.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_4{
	...
	java.io.File path_tFileDelete_4=new java.io.File(context.LocalPath+context.Customer_Raw);
    ...
    globalMap.put("tFileDelete_4_DELETE_PATH",context.LocalPath+context.Customer_Raw);
...
String fileName_tFileOutputDelimited_4 = "";
    fileName_tFileOutputDelimited_4 = (new java.io.File(context.LocalPath+context.Customer_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_4 != null && directory_tFileOutputDelimited_4.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_4, false),"UTF-8"));
                                    if(filetFileOutputDelimited_4.length()==0){
                                        outtFileOutputDelimited_4.write("CustomerID");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("NameStyle");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("Title");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("FirstName");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("MiddleName");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("LastName");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("Suffix");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("CompanyName");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("SalesPerson");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("EmailAddress");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("Phone");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("PasswordHash");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("PasswordSalt");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
...
+"odifiedDate\nFROM	SalesLT.Customer";
            ...
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_4 < 2) {
								row4.NameStyle = false;
							} else {
	                         		
            row4.NameStyle = rs_tDBInput_4.getBoolean(2);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.Title = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.Title = tmpContent_tDBInput_4;
                }
            } else {
                row4.Title = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.FirstName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.FirstName = tmpContent_tDBInput_4;
                }
            } else {
                row4.FirstName = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.MiddleName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.MiddleName = tmpContent_tDBInput_4;
                }
            } else {
                row4.MiddleName = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.LastName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.LastName = tmpContent_tDBInput_4;
                }
            } else {
                row4.LastName = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.Suffix = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.Suffix = tmpContent_tDBInput_4;
                }
            } else {
                row4.Suffix = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.CompanyName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.CompanyName = tmpContent_tDBInput_4;
                }
            } else {
                row4.CompanyName = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(9).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.SalesPerson = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.SalesPerson = tmpContent_tDBInput_4;
                }
            } else {
                row4.SalesPerson = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.EmailAddress = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.EmailAddress = tmpContent_tDBInput_4;
                }
            } else {
                row4.EmailAddress = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(11).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.Phone = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.Phone = tmpContent_tDBInput_4;
                }
            } else {
                row4.Phone = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(12).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.PasswordHash = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.PasswordHash = tmpContent_tDBInput_4;
                }
            } else {
                row4.PasswordHash = null;
            }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(13).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.PasswordSalt = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.PasswordSalt = tmpContent_tDBInput_4;
                }
            } else {
                row4.PasswordSalt = null;
            }
            ...
            row4.rowguid = rs_tDBInput_4.getObject(14);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row4.ModifiedDate = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 15);
	...
	currentComponent="tFileOutputDelimited_4";
                    ...
                    StringBuilder sb_tFileOutputDelimited_4 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_4.append(
                            ...
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.SalesPerson != null) {
                        sb_tFileOutputDelimited_4.append(
                            row4.SalesPerson
                        );
                            }
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.EmailAddress != null) {
                        sb_tFileOutputDelimited_4.append(
                            row4.EmailAddress
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_4.append(
                            ...
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.PasswordHash != null) {
                        sb_tFileOutputDelimited_4.append(
                            row4.PasswordHash
                        );
                            }
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.PasswordSalt != null) {
                        sb_tFileOutputDelimited_4.append(
                            row4.PasswordSalt
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_4.append(
                            FormatterUtils.format_Date(row4.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_5{
	...
	java.io.File path_tFileDelete_5=new java.io.File(context.LocalPath+context.CustomerAddress_Raw);
    ...
    globalMap.put("tFileDelete_5_DELETE_PATH",context.LocalPath+context.CustomerAddress_Raw);
...
String fileName_tFileOutputDelimited_5 = "";
    fileName_tFileOutputDelimited_5 = (new java.io.File(context.LocalPath+context.CustomerAddress_Raw)).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
		    ...
		    String dbquery_tDBInput_5 = "SELECT SalesLT.CustomerAddress.CustomerID,\n		SalesLT.CustomerAddress.AddressID,\n        SalesLT.CustomerAddress.Address"
+"Type,\n		SalesLT.CustomerAddress.rowguid,\n		SalesLT.CustomerAddress.ModifiedDate\nFROM	SalesLT.CustomerAddress";
            ...
            row5.CustomerID = rs_tDBInput_5.getInt(1);
            ...
            row5.AddressID = rs_tDBInput_5.getInt(2);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_5 < 3) {
								row5.AddressType = null;
							} else {
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.AddressType = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row5.AddressType = tmpContent_tDBInput_5;
                }
            } else {
                row5.AddressType = null;
            }
 ...
 */
	...
	currentComponent="tFileOutputDelimited_5";
                    ...
                    StringBuilder sb_tFileOutputDelimited_5 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_5.append(
                            FormatterUtils.format_Date(row5.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_6{
	...
	java.io.File path_tFileDelete_6=new java.io.File(context.LocalPath+context.Address_Raw);
    ...
    globalMap.put("tFileDelete_6_DELETE_PATH",context.LocalPath+context.Address_Raw);
...
String fileName_tFileOutputDelimited_6 = "";
    fileName_tFileOutputDelimited_6 = (new java.io.File(context.LocalPath+context.Address_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_6 != null && directory_tFileOutputDelimited_6.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_6, false),"UTF-8"));
                                    if(filetFileOutputDelimited_6.length()==0){
                                        outtFileOutputDelimited_6.write("AddressID");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
                                        outtFileOutputDelimited_6.write("AddressLine1");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
                                        outtFileOutputDelimited_6.write("AddressLine2");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
                                        outtFileOutputDelimited_6.write("City");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
                                        outtFileOutputDelimited_6.write("StateProvince");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
                                        outtFileOutputDelimited_6.write("CountryRegion");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
                                        outtFileOutputDelimited_6.write("PostalCode");
                                            outtFileOutputDelimited_6.write(OUT_DELIM_tFileOutputDelimited_6);
...
+".Address.rowguid,\n		SalesLT.Address.ModifiedDate\nFROM	SalesLT.Address";
            ...
            row6.AddressID = rs_tDBInput_6.getInt(1);
            if(rs_tDBInput_6.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_6 < 2) {
								row6.AddressLine1 = null;
							} else {
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.AddressLine1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row6.AddressLine1 = tmpContent_tDBInput_6;
                }
            } else {
                row6.AddressLine1 = null;
            }
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.AddressLine2 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row6.AddressLine2 = tmpContent_tDBInput_6;
                }
            } else {
                row6.AddressLine2 = null;
            }
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.City = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row6.City = tmpContent_tDBInput_6;
                }
            } else {
                row6.City = null;
            }
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.StateProvince = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row6.StateProvince = tmpContent_tDBInput_6;
                }
            } else {
                row6.StateProvince = null;
            }
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.CountryRegion = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row6.CountryRegion = tmpContent_tDBInput_6;
                }
            } else {
                row6.CountryRegion = null;
            }
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.PostalCode = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row6.PostalCode = tmpContent_tDBInput_6;
                }
            } else {
                row6.PostalCode = null;
            }
            ...
            row6.rowguid = rs_tDBInput_6.getObject(8);
            if(rs_tDBInput_6.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row6.ModifiedDate = mssqlGTU_tDBInput_6.getDate(rsmd_tDBInput_6, rs_tDBInput_6, 9);
	...
	currentComponent="tFileOutputDelimited_6";
                    ...
                    StringBuilder sb_tFileOutputDelimited_6 = new StringBuilder();
                        sb_tFileOutputDelimited_6.append(
                            ...
                            if(row6.AddressLine1 != null) {
                        sb_tFileOutputDelimited_6.append(
                            row6.AddressLine1
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row6.AddressLine2 != null) {
                        sb_tFileOutputDelimited_6.append(
                            row6.AddressLine2
                        );
                            }
...
class DeleteFoldertFileDelete_7{
	...
	java.io.File path_tFileDelete_7=new java.io.File(context.LocalPath+context.ProductCategory_Raw);
    ...
    globalMap.put("tFileDelete_7_DELETE_PATH",context.LocalPath+context.ProductCategory_Raw);
...
String fileName_tFileOutputDelimited_7 = "";
    fileName_tFileOutputDelimited_7 = (new java.io.File(context.LocalPath+context.ProductCategory_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_7 != null && directory_tFileOutputDelimited_7.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_7, false),"UTF-8"));
                                    if(filetFileOutputDelimited_7.length()==0){
                                        ...
                                        outtFileOutputDelimited_7.write("ParentProductCategoryID");
                                            outtFileOutputDelimited_7.write(OUT_DELIM_tFileOutputDelimited_7);
 ...
 */
	...
	currentComponent="tDBInput_7";
		...
		int tos_count_tDBInput_7 = 0;
		    ...
		    String dbquery_tDBInput_7 = "SELECT SalesLT.ProductCategory.ProductCategoryID,\n		SalesLT.ProductCategory.ParentProductCategoryID,\n		SalesLT.ProductC"
+"ategory.rowguid,\n		SalesLT.ProductCategory.ModifiedDate\nFROM	SalesLT.ProductCategory";
            ...
            row7.ProductCategoryID = rs_tDBInput_7.getInt(1);
            ...
            row7.ParentProductCategoryID = rs_tDBInput_7.getInt(2);
            if(rs_tDBInput_7.wasNull()){
                    row7.ParentProductCategoryID = null;
            }
		                    }
	...
	currentComponent="tFileOutputDelimited_7";
                    ...
                    StringBuilder sb_tFileOutputDelimited_7 = new StringBuilder();
                        sb_tFileOutputDelimited_7.append(
                            row7.ProductCategoryID
                        );
                            sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
                            if(row7.ParentProductCategoryID != null) {
                        sb_tFileOutputDelimited_7.append(
                            row7.ParentProductCategoryID
                        );
                            }
                            sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
                        ...
                        sb_tFileOutputDelimited_7.append(
                            FormatterUtils.format_Date(row7.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_8{
	...
	java.io.File path_tFileDelete_8=new java.io.File(context.LocalPath+context.ProductDescription_Raw);
    ...
    globalMap.put("tFileDelete_8_DELETE_PATH",context.LocalPath+context.ProductDescription_Raw);
...
String fileName_tFileOutputDelimited_8 = "";
    fileName_tFileOutputDelimited_8 = (new java.io.File(context.LocalPath+context.ProductDescription_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_8 != null && directory_tFileOutputDelimited_8.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_8, false),"UTF-8"));
                                    if(filetFileOutputDelimited_8.length()==0){
                                        ...
                                        outtFileOutputDelimited_8.write("Description");
                                            outtFileOutputDelimited_8.write(OUT_DELIM_tFileOutputDelimited_8);
 ...
 */
	...
	currentComponent="tDBInput_8";
		...
		int tos_count_tDBInput_8 = 0;
		    ...
		    String dbquery_tDBInput_8 = "SELECT SalesLT.ProductDescription.ProductDescriptionID,\n		SalesLT.ProductDescription.Description,\n		SalesLT.ProductDesc"
+"ription.rowguid,\n		SalesLT.ProductDescription.ModifiedDate\nFROM	SalesLT.ProductDescription";
            ...
            row8.ProductDescriptionID = rs_tDBInput_8.getInt(1);
            ...
            if(tmpContent_tDBInput_8 != null) {
            	if (talendToDBList_tDBInput_8 .contains(rsmd_tDBInput_8.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row8.Description = FormatterUtils.formatUnwithE(tmpContent_tDBInput_8);
            	} else {
                	row8.Description = tmpContent_tDBInput_8;
                }
            } else {
                row8.Description = null;
            }
            ...
            row8.rowguid = rs_tDBInput_8.getObject(3);
            if(rs_tDBInput_8.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row8.ModifiedDate = mssqlGTU_tDBInput_8.getDate(rsmd_tDBInput_8, rs_tDBInput_8, 4);
 ...
 */
	...
	currentComponent="tFileOutputDelimited_8";
                    ...
                    StringBuilder sb_tFileOutputDelimited_8 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_8.append(
                            FormatterUtils.format_Date(row8.ModifiedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
...
class DeleteFoldertFileDelete_9{
	...
	java.io.File path_tFileDelete_9=new java.io.File(context.LocalPath+context.ProductModel_Raw);
    ...
    globalMap.put("tFileDelete_9_DELETE_PATH",context.LocalPath+context.ProductModel_Raw);
...
String fileName_tFileOutputDelimited_9 = "";
    fileName_tFileOutputDelimited_9 = (new java.io.File(context.LocalPath+context.ProductModel_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_9 != null && directory_tFileOutputDelimited_9.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_9, false),"UTF-8"));
                                    if(filetFileOutputDelimited_9.length()==0){
                                        outtFileOutputDelimited_9.write("ProductModelID");
                                            outtFileOutputDelimited_9.write(OUT_DELIM_tFileOutputDelimited_9);
                                        outtFileOutputDelimited_9.write("Name");
                                            outtFileOutputDelimited_9.write(OUT_DELIM_tFileOutputDelimited_9);
 ...
 */
	...
	currentComponent="tDBInput_9";
		...
		int tos_count_tDBInput_9 = 0;
		    ...
		    String dbquery_tDBInput_9 = "SELECT SalesLT.ProductModel.ProductModelID,\n        SalesLT.ProductModel.Name,\n		SalesLT.ProductModel.rowguid,\n		SalesL"
+"T.ProductModel.ModifiedDate\nFROM	SalesLT.ProductModel";
		    ...
		    while (rs_tDBInput_9.next()) {
		        nb_line_tDBInput_9++;
							...
							if(colQtyInRs_tDBInput_9 < 1) {
								row9.ProductModelID = 0;
							} else {
		                          
            row9.ProductModelID = rs_tDBInput_9.getInt(1);
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row9.Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_9);
            	} else {
                	row9.Name = tmpContent_tDBInput_9;
                }
            } else {
                row9.Name = null;
            }
            ...
            row9.rowguid = rs_tDBInput_9.getObject(3);
            if(rs_tDBInput_9.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row9.ModifiedDate = mssqlGTU_tDBInput_9.getDate(rsmd_tDBInput_9, rs_tDBInput_9, 4);
...
class DeleteFoldertFileDelete_10{
	...
	java.io.File path_tFileDelete_10=new java.io.File(context.LocalPath+context.ProductModelProductDescription_Raw);
    ...
    globalMap.put("tFileDelete_10_DELETE_PATH",context.LocalPath+context.ProductModelProductDescription_Raw);
...
String fileName_tFileOutputDelimited_10 = "";
    fileName_tFileOutputDelimited_10 = (new java.io.File(context.LocalPath+context.ProductModelProductDescription_Raw)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_10 != null && directory_tFileOutputDelimited_10.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_10, false),"UTF-8"));
                                    if(filetFileOutputDelimited_10.length()==0){
                                        ...
                                        outtFileOutputDelimited_10.write("ProductDescriptionID");
                                            outtFileOutputDelimited_10.write(OUT_DELIM_tFileOutputDelimited_10);
                                        outtFileOutputDelimited_10.write("Culture");
                                            outtFileOutputDelimited_10.write(OUT_DELIM_tFileOutputDelimited_10);
 ...
 */
	...
	currentComponent="tDBInput_10";
		...
		int tos_count_tDBInput_10 = 0;
		    ...
		    String dbquery_tDBInput_10 = "SELECT SalesLT.ProductModelProductDescription.ProductModelID,\n		SalesLT.ProductModelProductDescription.ProductDescripti"
...
+"uctModelProductDescription.ModifiedDate\nFROM	SalesLT.ProductModelProductDescription";
            ...
            if(rs_tDBInput_10.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_10 < 2) {
								row10.ProductDescriptionID = 0;
							} else {
		                          
            row10.ProductDescriptionID = rs_tDBInput_10.getInt(2);
            if(rs_tDBInput_10.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_10 != null) {
            	if (talendToDBList_tDBInput_10 .contains(rsmd_tDBInput_10.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row10.Culture = FormatterUtils.formatUnwithE(tmpContent_tDBInput_10);
            	} else {
                	row10.Culture = tmpContent_tDBInput_10;
                }
            } else {
                row10.Culture = null;
            }
	...
	currentComponent="tFileOutputDelimited_10";
                    ...
                    StringBuilder sb_tFileOutputDelimited_10 = new StringBuilder();
                        sb_tFileOutputDelimited_10.append(
                            row10.ProductModelID
                        );
                            sb_tFileOutputDelimited_10.append(OUT_DELIM_tFileOutputDelimited_10);
                        sb_tFileOutputDelimited_10.append(
                            row10.ProductDescriptionID
                        );
                            sb_tFileOutputDelimited_10.append(OUT_DELIM_tFileOutputDelimited_10);
                            if(row10.Culture != null) {
                        sb_tFileOutputDelimited_10.append(
                            row10.Culture
                        );
                            }
 ...
 */
    ...
    public static void main(String[] args){
        final Raw_Data Raw_DataClass = new Raw_Data();

        int exitCode = Raw_DataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Raw_Data.class.getClassLoader().getResourceAsStream("trab_final/raw_data_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Raw_Data.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Raw_Data");
        }
...
/************************************************************************************************
 *     371986 characters generated by Talend Open Studio for Big Data 
 *     on the 1 de Maio de 2021 20h30min59s BRT
 ************************************************************************************************/