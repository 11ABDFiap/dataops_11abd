...
package trab_final.curated_product_sales_0_1;
...
/**
 * Job: Curated_Product_Sales Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Curated_Product_Sales implements TalendJob {
...
public String getSalesOrderHeader_Raw(){
	...
	private final String jobName = "Curated_Product_Sales";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Curated_Product_Sales.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Curated_Product_Sales.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_TRAB_FINAL_Curated_Product_Sales = new byte[0];
    static byte[] commonByteArray_TRAB_FINAL_Curated_Product_Sales = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TRAB_FINAL_Curated_Product_Sales.length) {
				if(length < 1024 && commonByteArray_TRAB_FINAL_Curated_Product_Sales.length == 0) {
   					commonByteArray_TRAB_FINAL_Curated_Product_Sales = new byte[1024];
				} else {
   					commonByteArray_TRAB_FINAL_Curated_Product_Sales = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TRAB_FINAL_Curated_Product_Sales, 0, length);
			strReturn = new String(commonByteArray_TRAB_FINAL_Curated_Product_Sales, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TRAB_FINAL_Curated_Product_Sales) {
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
								...
								result = prime * result + (int) this.UnitPriceDiscount;
							...
							result = prime * result + ((this.Color == null) ? 0 : this.Color.hashCode());
								...
								result = prime * result + (int) this.StandardCost;
							
								result = prime * result + (int) this.ListPrice;
							...
							result = prime * result + ((this.ModelName == null) ? 0 : this.ModelName.hashCode());
								...
								result = prime * result + (int) this.Week;
		...
		public boolean equals(Object obj) {
			...
			final AggOperationStruct_tAggregateRow_1 other = (AggOperationStruct_tAggregateRow_1) obj;
							...
							if (this.UnitPriceDiscount != other.UnitPriceDiscount) 
								return false;
							...
							if (this.StandardCost != other.StandardCost) 
								return false;
...
if(row1 != null) { 
	...
	row4.UnitPrice = row1.UnitPrice;

	
	row4.UnitPriceDiscount = row1.UnitPriceDiscount;
 					    ...
 					    boolean forceLooprow14 = false;
 							...
 							row14Struct row14ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row14__CustomerID = row9.CustomerID ;
	                        		    	if(exprKeyValue_row14__CustomerID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row14HashKey.CustomerID = (int)(Integer) exprKeyValue_row14__CustomerID;
                        		    		}
				           		...
				           		if(tHash_Lookup_row14 != null && tHash_Lookup_row14.getCount(row14HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row14' and it contains more one result from keys :  row14.CustomerID = '" + row14HashKey.CustomerID + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow18 = false;
 							...
 							row18Struct row18ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row18__ProductCategoryID = row8.ProductCategoryID ;
	                        		    	if(exprKeyValue_row18__ProductCategoryID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row18HashKey.ProductCategoryID = (int)(Integer) exprKeyValue_row18__ProductCategoryID;
                        		    		}
				           		...
				           		if(tHash_Lookup_row18 != null && tHash_Lookup_row18.getCount(row18HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row18' and it contains more one result from keys :  row18.ProductCategoryID = '" + row18HashKey.ProductCategoryID + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow20 = false;
 							...
 							row20Struct row20ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row20__ProductModelID = row8.ProductModelID ;
	                        		    	if(exprKeyValue_row20__ProductModelID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row20HashKey.ProductModelID = (int)(Integer) exprKeyValue_row20__ProductModelID;
                        		    		}
				           		...
				           		if(tHash_Lookup_row20 != null && tHash_Lookup_row20.getCount(row20HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row20' and it contains more one result from keys :  row20.ProductModelID = '" + row20HashKey.ProductModelID + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow22 = false;
 							...
 							row22Struct row22ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row22__ProductModelID = row8.ProductModelID ;
	                        		    	if(exprKeyValue_row22__ProductModelID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row22HashKey.ProductModelID = (int)(Integer) exprKeyValue_row22__ProductModelID;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row22__ProductDescriptionID = row16.ProductDescriptionID ;
	                        		    	if(exprKeyValue_row22__ProductDescriptionID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row22HashKey.ProductDescriptionID = (int)(Integer) exprKeyValue_row22__ProductDescriptionID;
                        		    		}
				           		...
				           		if(tHash_Lookup_row22 != null && tHash_Lookup_row22.getCount(row22HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row22' and it contains more one result from keys :  row22.ProductModelID = '" + row22HashKey.ProductModelID + "', row22.ProductDescriptionID = '" + row22HashKey.ProductDescriptionID + "'");
								} // G 071
...
Var.Week = TalendDate.getPartOfDate("WEEK",row7.OrderDate) + 1 ;// ###############################
        // ###############################
        // # Output tables
...
out1_tmp.UnitPrice = row4.UnitPrice ;
out1_tmp.UnitPriceDiscount = row4.UnitPriceDiscount ;
out1_tmp.OrderDate = row7.OrderDate ;
out1_tmp.ProductName = row8.Name ;
out1_tmp.Color = row8.Color ;
out1_tmp.StandardCost = row8.StandardCost ;
out1_tmp.ListPrice = row8.ListPrice ;
out1_tmp.Size = row8.Size ;
out1_tmp.Weight = row8.Weight ;
out1_tmp.DiscontinuedDate = row8.DiscontinuedDate ;
out1_tmp.SalesPerson = row14.SalesPerson ;
out1_tmp.ModelName = row20.Name ;
out1_tmp.Week = Var.Week ;
...
operation_finder_tAggregateRow_1.UnitPrice = out1.UnitPrice;
			operation_finder_tAggregateRow_1.UnitPriceDiscount = out1.UnitPriceDiscount;
			operation_finder_tAggregateRow_1.OrderDate = out1.OrderDate;
			operation_finder_tAggregateRow_1.ProductName = out1.ProductName;
			operation_finder_tAggregateRow_1.Color = out1.Color;
			operation_finder_tAggregateRow_1.StandardCost = out1.StandardCost;
			operation_finder_tAggregateRow_1.ListPrice = out1.ListPrice;
			operation_finder_tAggregateRow_1.Size = out1.Size;
			operation_finder_tAggregateRow_1.Weight = out1.Weight;
			operation_finder_tAggregateRow_1.DiscontinuedDate = out1.DiscontinuedDate;
			operation_finder_tAggregateRow_1.SalesPerson = out1.SalesPerson;
			operation_finder_tAggregateRow_1.ModelName = out1.ModelName;
			operation_finder_tAggregateRow_1.Week = out1.Week;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.UnitPrice = operation_finder_tAggregateRow_1.UnitPrice;
				operation_result_tAggregateRow_1.UnitPriceDiscount = operation_finder_tAggregateRow_1.UnitPriceDiscount;
				...
				operation_result_tAggregateRow_1.StandardCost = operation_finder_tAggregateRow_1.StandardCost;
				operation_result_tAggregateRow_1.ListPrice = operation_finder_tAggregateRow_1.ListPrice;
				...
				operation_result_tAggregateRow_1.ModelName = operation_finder_tAggregateRow_1.ModelName;
				operation_result_tAggregateRow_1.Week = operation_finder_tAggregateRow_1.Week;
...
row11.OrderQty = aggregated_row_tAggregateRow_1.OrderQty_sum;
            				    ...
            				    row11.UnitPrice = aggregated_row_tAggregateRow_1.UnitPrice;
            				    
            				    row11.UnitPriceDiscount = aggregated_row_tAggregateRow_1.UnitPriceDiscount;
            				    
            				    row11.OrderDate = aggregated_row_tAggregateRow_1.OrderDate;
            				    
            				    row11.ProductName = aggregated_row_tAggregateRow_1.ProductName;
            				    
            				    row11.Color = aggregated_row_tAggregateRow_1.Color;
            				    
            				    row11.StandardCost = aggregated_row_tAggregateRow_1.StandardCost;
            				    
            				    row11.ListPrice = aggregated_row_tAggregateRow_1.ListPrice;
            				    
            				    row11.Size = aggregated_row_tAggregateRow_1.Size;
            				    
            				    row11.Weight = aggregated_row_tAggregateRow_1.Weight;
            				    
            				    row11.DiscontinuedDate = aggregated_row_tAggregateRow_1.DiscontinuedDate;
            				    
            				    row11.SalesPerson = aggregated_row_tAggregateRow_1.SalesPerson;
            				    
            				    row11.ModelName = aggregated_row_tAggregateRow_1.ModelName;
            				    
            				    row11.Week = aggregated_row_tAggregateRow_1.Week;
 ...
 */
	...
	arrayRowtSortRow_1_SortOut.UnitPrice = row11.UnitPrice;
	arrayRowtSortRow_1_SortOut.UnitPriceDiscount = row11.UnitPriceDiscount;
	arrayRowtSortRow_1_SortOut.OrderDate = row11.OrderDate;
	arrayRowtSortRow_1_SortOut.ProductName = row11.ProductName;
	arrayRowtSortRow_1_SortOut.Color = row11.Color;
	arrayRowtSortRow_1_SortOut.StandardCost = row11.StandardCost;
	arrayRowtSortRow_1_SortOut.ListPrice = row11.ListPrice;
	arrayRowtSortRow_1_SortOut.Size = row11.Size;
	arrayRowtSortRow_1_SortOut.Weight = row11.Weight;
	arrayRowtSortRow_1_SortOut.DiscontinuedDate = row11.DiscontinuedDate;
	arrayRowtSortRow_1_SortOut.SalesPerson = row11.SalesPerson;
	arrayRowtSortRow_1_SortOut.ModelName = row11.ModelName;
	arrayRowtSortRow_1_SortOut.Week = row11.Week;
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.LocalPath+context.reportProductSalesBI)).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("SalesPerson");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ModelName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Week");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
...
for(int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++){
	...
	row12.UnitPrice = current_tSortRow_1_SortIn.UnitPrice;
	row12.UnitPriceDiscount = current_tSortRow_1_SortIn.UnitPriceDiscount;
	row12.OrderDate = current_tSortRow_1_SortIn.OrderDate;
	row12.ProductName = current_tSortRow_1_SortIn.ProductName;
	row12.Color = current_tSortRow_1_SortIn.Color;
	row12.StandardCost = current_tSortRow_1_SortIn.StandardCost;
	row12.ListPrice = current_tSortRow_1_SortIn.ListPrice;
	row12.Size = current_tSortRow_1_SortIn.Size;
	row12.Weight = current_tSortRow_1_SortIn.Weight;
	row12.DiscontinuedDate = current_tSortRow_1_SortIn.DiscontinuedDate;
	row12.SalesPerson = current_tSortRow_1_SortIn.SalesPerson;
	row12.ModelName = current_tSortRow_1_SortIn.ModelName;
	row12.Week = current_tSortRow_1_SortIn.Week;
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row12.Weight != null) {
                        sb_tFileOutputDelimited_1.append(
                            row12.Weight.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row12.DiscontinuedDate != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row12.DiscontinuedDate, "yyyy-MM-dd'T'HH:mm:ss")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row12.SalesPerson != null) {
                        sb_tFileOutputDelimited_1.append(
                            row12.SalesPerson
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row12.ModelName != null) {
                        sb_tFileOutputDelimited_1.append(
                            row12.ModelName
                        );
                            }
...
row7Struct row7 = new row7Struct();
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row4,row7,row8,row9,row10,row14,row16,row18,row20,row22) outputs:(out1)
...
if(row3 != null) { 
	...
	row8.Color = row3.Color;

	
	row8.StandardCost = row3.StandardCost;

	
	row8.ListPrice = row3.ListPrice;

	
	row8.Size = row3.Size;

	
	row8.Weight = row3.Weight;

	
	row8.ProductCategoryID = row3.ProductCategoryID;

	
	row8.ProductModelID = row3.ProductModelID;

	
	row8.DiscontinuedDate = row3.DiscontinuedDate;

	
	row8.SellStartDate = row3.SellStartDate;

	
	row8.SellEndDate = row3.SellEndDate;
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
				...
				row8_HashRow.StandardCost = row8.StandardCost;
				
				row8_HashRow.ListPrice = row8.ListPrice;
				
				row8_HashRow.Size = row8.Size;
				
				row8_HashRow.Weight = row8.Weight;
				
				row8_HashRow.ProductCategoryID = row8.ProductCategoryID;
				
				row8_HashRow.ProductModelID = row8.ProductModelID;
				
				row8_HashRow.DiscontinuedDate = row8.DiscontinuedDate;
				
				row8_HashRow.SellStartDate = row8.SellStartDate;
				
				row8_HashRow.SellEndDate = row8.SellEndDate;
...
row14Struct row14 = new row14Struct();
	...
	currentComponent="tAdvancedHash_row14";
		...
		int tos_count_tAdvancedHash_row14 = 0;
			   		...
			   		// source node:tFilterColumns_4 - inputs:(row13) outputs:(row14,row14) | target node:tAdvancedHash_row14 - inputs:(row14) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row7,row8,row9,row10,row14,row16,row18,row20,row22) outputs:(out1)
			...
			if(footer_value_tFileInputDelimited_4 >0 || random_value_tFileInputDelimited_4 > 0){
				...
				int columnIndexWithD_tFileInputDelimited_4 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CustomerID", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
								...
								try {
									...
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't set default value for column '%s' in '%s'. Details: %s",
										"CustomerID", "row13", ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
					...
					columnIndexWithD_tFileInputDelimited_4 = 1;
							...
							row13.FirstName = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 2;
					
							row13.MiddleName = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 3;
					
							row13.LastName = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 4;
					
							row13.Suffix = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 5;
					
							row13.CompanyName = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 6;
					
							row13.SalesPerson = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 7;
					
							row13.EmailAddress = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
						
				
					columnIndexWithD_tFileInputDelimited_4 = 8;
					
							row13.Phone = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
					...
					columnIndexWithD_tFileInputDelimited_4 = 9;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									row13.ModifiedDate = ParserUtils.parseTo_Date(temp, "yyyy-MM-dd'T'HH:mm:ss");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_4) {
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ModifiedDate", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
if(row13 != null) { 
	...
	row14.SalesPerson = row13.SalesPerson;
 ...
 */
	...
	currentComponent="tAdvancedHash_row14";
				...
				row14_HashRow.CustomerID = row14.CustomerID;
				
				row14_HashRow.SalesPerson = row14.SalesPerson;
...
row16Struct row16 = new row16Struct();
	...
	currentComponent="tAdvancedHash_row16";
		...
		int tos_count_tAdvancedHash_row16 = 0;
			   		...
			   		// source node:tFilterColumns_7 - inputs:(row15) outputs:(row16,row16) | target node:tAdvancedHash_row16 - inputs:(row16) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row7,row8,row9,row10,row14,row16,row18,row20,row22) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_7 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_7 = context.LocalPath+context.ProductDescription_Harmonized;
			...
			if(footer_value_tFileInputDelimited_7 >0 || random_value_tFileInputDelimited_7 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_7 = new org.talend.fileprocess.FileInputDelimited(context.LocalPath+context.ProductDescription_Harmonized, "UTF-8",";","\n",true,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_7 = 0;
					...
					columnIndexWithD_tFileInputDelimited_7 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row15.ProductDescriptionID = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_7.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ProductDescriptionID", "row15", temp, ex_tFileInputDelimited_7), ex_tFileInputDelimited_7));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_7.setException(new RuntimeException("Value is empty for column : 'ProductDescriptionID' in 'row15' connection, value is invalid or this column should be nullable or have a default value."));
					...
					columnIndexWithD_tFileInputDelimited_7 = 1;
							...
							row15.Description = fid_tFileInputDelimited_7.get(columnIndexWithD_tFileInputDelimited_7);
					...
					columnIndexWithD_tFileInputDelimited_7 = 2;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									row15.ModifiedDate = ParserUtils.parseTo_Date(temp, "yyyy-MM-dd'T'HH:mm:ss");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_7) {
									rowstate_tFileInputDelimited_7.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ModifiedDate", "row15", temp, ex_tFileInputDelimited_7), ex_tFileInputDelimited_7));
								}
...
if(row15 != null) { 
	...
	row16.ProductDescriptionID = row15.ProductDescriptionID;

	
	row16.Description = row15.Description;
 ...
 */
	...
	currentComponent="tAdvancedHash_row16";
				...
				row16_HashRow.ProductDescriptionID = row16.ProductDescriptionID;
 ...
 */
	...
	currentComponent="tFileInputDelimited_7";
                ...
                if(!((Object)(context.LocalPath+context.ProductDescription_Harmonized) instanceof java.io.InputStream)){
...
row18Struct row18 = new row18Struct();
	...
	currentComponent="tAdvancedHash_row18";
		...
		int tos_count_tAdvancedHash_row18 = 0;
			   		...
			   		// source node:tFilterColumns_8 - inputs:(row17) outputs:(row18,row18) | target node:tAdvancedHash_row18 - inputs:(row18) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row7,row8,row9,row10,row14,row16,row18,row20,row22) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_8 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_8 = context.LocalPath+context.ProductCategory_Harmonized;
			...
			if(footer_value_tFileInputDelimited_8 >0 || random_value_tFileInputDelimited_8 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited(context.LocalPath+context.ProductCategory_Harmonized, "UTF-8",";","\n",true,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_8 = 0;
					...
					columnIndexWithD_tFileInputDelimited_8 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row17.ProductCategoryID = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ProductCategoryID", "row17", temp, ex_tFileInputDelimited_8), ex_tFileInputDelimited_8));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_8.setException(new RuntimeException("Value is empty for column : 'ProductCategoryID' in 'row17' connection, value is invalid or this column should be nullable or have a default value."));
					...
					columnIndexWithD_tFileInputDelimited_8 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row17.ParentProductCategoryID = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_8) {
									rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ParentProductCategoryID", "row17", temp, ex_tFileInputDelimited_8), ex_tFileInputDelimited_8));
								}
    							
						} else {						
							
								
									row17.ParentProductCategoryID = null;
					...
					columnIndexWithD_tFileInputDelimited_8 = 2;
							...
							row17.rowguid = fid_tFileInputDelimited_8.get(columnIndexWithD_tFileInputDelimited_8);
					...
					columnIndexWithD_tFileInputDelimited_8 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									row17.ModifiedDate = ParserUtils.parseTo_Date(temp, "yyyy-MM-dd'T'HH:mm:ss");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_8) {
									rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ModifiedDate", "row17", temp, ex_tFileInputDelimited_8), ex_tFileInputDelimited_8));
								}
...
if(row17 != null) { 
	...
	row18.ProductCategoryID = row17.ProductCategoryID;
 ...
 */
	...
	currentComponent="tFileInputDelimited_8";
                ...
                if(!((Object)(context.LocalPath+context.ProductCategory_Harmonized) instanceof java.io.InputStream)){
...
row20Struct row20 = new row20Struct();
	...
	currentComponent="tAdvancedHash_row20";
		...
		int tos_count_tAdvancedHash_row20 = 0;
			   		...
			   		// source node:tFilterColumns_9 - inputs:(row19) outputs:(row20,row20) | target node:tAdvancedHash_row20 - inputs:(row20) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row7,row8,row9,row10,row14,row16,row18,row20,row22) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_9 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_9 = context.LocalPath+context.ProductModel_Harmonized;
			...
			if(footer_value_tFileInputDelimited_9 >0 || random_value_tFileInputDelimited_9 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited(context.LocalPath+context.ProductModel_Harmonized, "UTF-8",";","\n",true,1,0,
					...
					columnIndexWithD_tFileInputDelimited_9 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row19.ProductModelID = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ProductModelID", "row19", temp, ex_tFileInputDelimited_9), ex_tFileInputDelimited_9));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_9.setException(new RuntimeException("Value is empty for column : 'ProductModelID' in 'row19' connection, value is invalid or this column should be nullable or have a default value."));
...
if(row19 != null) { 
	...
	row20.ProductModelID = row19.ProductModelID;

	
	row20.Name = row19.Name;
 ...
 */
	...
	currentComponent="tAdvancedHash_row20";
				...
				row20_HashRow.ProductModelID = row20.ProductModelID;
				
				row20_HashRow.Name = row20.Name;
...
row22Struct row22 = new row22Struct();
	...
	currentComponent="tAdvancedHash_row22";
		...
		int tos_count_tAdvancedHash_row22 = 0;
			   		...
			   		// source node:tFilterColumns_10 - inputs:(row21) outputs:(row22,row22) | target node:tAdvancedHash_row22 - inputs:(row22) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row7,row8,row9,row10,row14,row16,row18,row20,row22) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_10 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_10 = context.LocalPath+context.ProductModelProductDescription_Harmonized;
			...
			if(footer_value_tFileInputDelimited_10 >0 || random_value_tFileInputDelimited_10 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_10 = new org.talend.fileprocess.FileInputDelimited(context.LocalPath+context.ProductModelProductDescription_Harmonized, "UTF-8",";","\n",true,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_10 = 0;
					...
					columnIndexWithD_tFileInputDelimited_10 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row21.ProductModelID = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ProductModelID", "row21", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_10.setException(new RuntimeException("Value is empty for column : 'ProductModelID' in 'row21' connection, value is invalid or this column should be nullable or have a default value."));
					...
					columnIndexWithD_tFileInputDelimited_10 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row21.ProductDescriptionID = ParserUtils.parseTo_int(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ProductDescriptionID", "row21", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_10.setException(new RuntimeException("Value is empty for column : 'ProductDescriptionID' in 'row21' connection, value is invalid or this column should be nullable or have a default value."));
					...
					columnIndexWithD_tFileInputDelimited_10 = 2;
							...
							row21.Culture = fid_tFileInputDelimited_10.get(columnIndexWithD_tFileInputDelimited_10);
...
if(row21 != null) { 
	...
	row22.ProductModelID = row21.ProductModelID;

	
	row22.ProductDescriptionID = row21.ProductDescriptionID;
 ...
 */
	...
	currentComponent="tAdvancedHash_row22";
				...
				row22_HashRow.ProductModelID = row22.ProductModelID;
				
				row22_HashRow.ProductDescriptionID = row22.ProductDescriptionID;
 ...
 */
	...
	currentComponent="tFileInputDelimited_10";
                ...
                if(!((Object)(context.LocalPath+context.ProductModelProductDescription_Harmonized) instanceof java.io.InputStream)){
...
class DeleteFoldertFileDelete_1{
	...
	java.io.File path_tFileDelete_1=new java.io.File(context.LocalPath+context.reportProductSalesBI);
    ...
    globalMap.put("tFileDelete_1_DELETE_PATH",context.LocalPath+context.reportProductSalesBI);
 ...
 */
    ...
    public static void main(String[] args){
        final Curated_Product_Sales Curated_Product_SalesClass = new Curated_Product_Sales();

        int exitCode = Curated_Product_SalesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Curated_Product_Sales.class.getClassLoader().getResourceAsStream("trab_final/curated_product_sales_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Curated_Product_Sales.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Curated_Product_Sales");
        }
...
/************************************************************************************************
 *     444294 characters generated by Talend Open Studio for Big Data 
 *     on the 1 de Maio de 2021 20h32min12s BRT
 ************************************************************************************************/