...
with DAG('talend_api_jobs',
    ...
    mensal = BashOperator(
        task_id='talend_mensal',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts/diario
        unzip -zxvf Curated_Product_0.1.zip
        cd  $AIRFLOW_HOME/dags/etl_scripts/diario/Curated_Product_0.1/Curated_Product/
        chmod 775 Curated_Product_run.sh
        ./Curated_Product_run.sh
        """)
